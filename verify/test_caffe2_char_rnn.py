...
def main():
    ...
    parser.add_argument("--train_data", type=str, default='data/shakespeare.txt',
    ...
    print('WARNING: to use GPU, you need *exactly* the same cuDNN version as the caffe2 build')
